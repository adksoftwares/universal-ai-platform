...
let LifeIntelligenceModule = class LifeIntelligenceModule {
};
LifeIntelligenceModule = __decorate([
    Module({
        controllers: [LifeIntelligenceController],
        providers: [LifeIntelligenceService, PrismaService],
    })
], LifeIntelligenceModule);
export { LifeIntelligenceModule };
//# sourceMappingURL=life-intelligence.module.js.map