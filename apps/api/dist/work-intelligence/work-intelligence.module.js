...
let WorkIntelligenceModule = class WorkIntelligenceModule {
};
WorkIntelligenceModule = __decorate([
    Module({
        controllers: [WorkIntelligenceController],
        providers: [WorkIntelligenceService, PrismaService],
    })
], WorkIntelligenceModule);
export { WorkIntelligenceModule };
//# sourceMappingURL=work-intelligence.module.js.map