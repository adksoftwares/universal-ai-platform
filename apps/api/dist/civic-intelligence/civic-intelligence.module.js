...
let CivicIntelligenceModule = class CivicIntelligenceModule {
};
CivicIntelligenceModule = __decorate([
    Module({
        controllers: [CivicIntelligenceController],
        providers: [CivicIntelligenceService, PrismaService],
    })
], CivicIntelligenceModule);
export { CivicIntelligenceModule };
//# sourceMappingURL=civic-intelligence.module.js.map