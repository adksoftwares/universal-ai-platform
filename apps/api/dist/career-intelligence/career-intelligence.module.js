...
let CareerIntelligenceModule = class CareerIntelligenceModule {
};
CareerIntelligenceModule = __decorate([
    Module({
        controllers: [CareerIntelligenceController],
        providers: [CareerIntelligenceService, PrismaService],
    })
], CareerIntelligenceModule);
export { CareerIntelligenceModule };
//# sourceMappingURL=career-intelligence.module.js.map