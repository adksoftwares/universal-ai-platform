...
let ShoppingIntelligenceModule = class ShoppingIntelligenceModule {
};
ShoppingIntelligenceModule = __decorate([
    Module({
        controllers: [ShoppingIntelligenceController],
        providers: [ShoppingIntelligenceService, PrismaService],
    })
], ShoppingIntelligenceModule);
export { ShoppingIntelligenceModule };
//# sourceMappingURL=shopping-intelligence.module.js.map