...
let SocialIntelligenceModule = class SocialIntelligenceModule {
};
SocialIntelligenceModule = __decorate([
    Module({
        controllers: [SocialIntelligenceController],
        providers: [SocialIntelligenceService, PrismaService],
    })
], SocialIntelligenceModule);
export { SocialIntelligenceModule };
//# sourceMappingURL=social-intelligence.module.js.map