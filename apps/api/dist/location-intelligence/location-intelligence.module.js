...
let LocationIntelligenceModule = class LocationIntelligenceModule {
};
LocationIntelligenceModule = __decorate([
    Module({
        controllers: [LocationIntelligenceController],
        providers: [LocationIntelligenceService, PrismaService],
    })
], LocationIntelligenceModule);
export { LocationIntelligenceModule };
//# sourceMappingURL=location-intelligence.module.js.map