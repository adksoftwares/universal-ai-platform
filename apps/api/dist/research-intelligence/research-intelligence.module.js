...
let ResearchIntelligenceModule = class ResearchIntelligenceModule {
};
ResearchIntelligenceModule = __decorate([
    Module({
        controllers: [ResearchIntelligenceController],
        providers: [ResearchIntelligenceService, PrismaService],
    })
], ResearchIntelligenceModule);
export { ResearchIntelligenceModule };
//# sourceMappingURL=research-intelligence.module.js.map