...
let FinanceIntelligenceModule = class FinanceIntelligenceModule {
};
FinanceIntelligenceModule = __decorate([
    Module({
        controllers: [FinanceIntelligenceController],
        providers: [FinanceIntelligenceService, PrismaService],
    })
], FinanceIntelligenceModule);
export { FinanceIntelligenceModule };
//# sourceMappingURL=finance-intelligence.module.js.map