...
export declare class HealthController {
    ...
    getProfile(userId: string): import(".prisma/client").Prisma.Prisma__HealthProfileClient<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        userId: string;
    ...
    upsertProfile(userId: string, data: any): import(".prisma/client").Prisma.Prisma__HealthProfileClient<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        userId: string;
