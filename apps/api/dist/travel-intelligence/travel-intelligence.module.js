...
let TravelIntelligenceModule = class TravelIntelligenceModule {
};
TravelIntelligenceModule = __decorate([
    Module({
        controllers: [TravelIntelligenceController],
        providers: [TravelIntelligenceService, PrismaService],
    })
], TravelIntelligenceModule);
export { TravelIntelligenceModule };
//# sourceMappingURL=travel-intelligence.module.js.map